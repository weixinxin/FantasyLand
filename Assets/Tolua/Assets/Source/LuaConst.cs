...
{
    public static string luaDir = Application.dataPath + "/Tolua/Assets/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/Tolua/Assets/ToLua/Lua";        //tolua lua文件目录
