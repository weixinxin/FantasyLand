...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.EndModule();
		L.EndModule();
		L.BeginModule("BattleSystem");
		BattleSystem_DamageTypeWrap.Register(L);
		L.BeginModule("SkillModule");
		BattleSystem_SkillModule_SkillWrap.Register(L);
		L.EndModule();
		L.BeginModule("ObjectModule");
		BattleSystem_ObjectModule_UnitBaseWrap.Register(L);
		L.EndModule();
		L.EndModule();
